...
CREATE TABLE IF NOT EXISTS `expert` (
  ...
  `Identity` varchar(100) CHARACTER SET utf8 DEFAULT NULL COMMENT '身份证号',
...
CREATE TABLE IF NOT EXISTS `project` (
  ...
  `Status` int(11) DEFAULT NULL COMMENT '状态(0未提交，1形式审查中，2形式审查合格，3形式审查不合格，4评审中,5特等奖，6一等奖，7二等奖，8三等奖，9未中奖)',
