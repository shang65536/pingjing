...
public class CompanyController extends Controller {
    ...
    public void save() {
        try {
            //重新获取对应的格式
            String _id = getPara("id");
            String _userName = getPara("Username");
            String _Password = getPara("Password");
            String _CompanyName = getPara("CompanyName");
            String _CreditCode = getPara("CreditCode");
            String _Email = getPara("Email");
            ...
            company.set("Username", _userName);
            company.set("Password", _Password);
            company.set("CompanyName", _CompanyName);
            company.set("CompanyFax", _CompanyFax);
            company.set("CreditCode", _CreditCode);
            company.set("Email", _Email);
            ...
            if (_id == null||_id=="") {
                ...
                Company com = Company.me.findById(_id);
                company.set("id", _id);
